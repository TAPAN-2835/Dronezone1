...
import { getProviderJobDetails, updateAssignmentStatus } from "@/lib/api/provider.server";
      ...
      <PageHeader
        ...
        actions={
          isNew ? (
            ...
            <Button onClick={() => router.navigate({ to: "/app/jobs/$id", params: { id: job.id } })}>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="mt-2 text-sm leading-relaxed text-foreground/90">{job.service_requests?.description}</p>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  <div className="flex aspect-video flex-col items-center justify-center rounded-lg border-2 border-dashed border-border bg-gradient-to-br from-muted/60 to-muted/30 p-3 text-center">
                    <span className="mt-1 text-[10px] font-medium text-muted-foreground">No images attached</span>
                  </div>
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-3 text-sm">
              <div className="flex items-start gap-2">
                ...
                <span>{job.service_requests?.addresses?.city}, {job.service_requests?.addresses?.state}</span>
              </div>
            </CardContent>
          </Card>
