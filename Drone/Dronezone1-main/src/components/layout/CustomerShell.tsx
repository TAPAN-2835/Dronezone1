...
export function CustomerShell({
  ...
  useEffect(() => {
    if (!loading) {
      if (!user) {
        navigate({ to: "/customer/onboarding", replace: true });
      } else if (role !== "customer") {
        if (role === "provider") navigate({ to: "/app/dashboard", replace: true });
        else if (role === "admin") navigate({ to: "/admin/dashboard", replace: true });
      }
    }
