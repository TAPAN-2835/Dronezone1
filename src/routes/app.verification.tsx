...
> = {
  ...
  approved: {
    ...
    message:
      "Welcome aboard! Your account is now active. You can start receiving and managing job requests.",
    color: "text-success",
  ...
  rejected: {
    ...
    message:
      "Unfortunately, your application was not approved. Please review the reason below and consider reapplying.",
  ...
  documents_required: {
    ...
    message:
      "We need a few more documents to complete your verification. Please upload the requested items below.",
    color: "text-primary",
      ...
      <main className="flex-1 flex items-center justify-center p-4 sm:p-6">
        <div className="w-full max-w-lg space-y-6">
                    ...
                    <div className="space-y-3">
                      <div className="rounded-lg border border-destructive/20 bg-card p-4 text-left">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Submitted certifications could not be verified. Please ensure your DGCA
                          certificate is valid and clearly legible.
                        </p>
                      </div>
                      <div className="grid gap-2 sm:grid-cols-2">
                        <Button
                          variant="outline"
                          onClick={() => toast.info("Support email: support@dronezone.com")}
                        >
                    ...
                    <div className="space-y-3 text-left">
                      <div className="rounded-lg border bg-card p-4">
                        ...
                        <ul className="space-y-2">
                          {[
                            "Valid DGCA Pilot Certificate (front & back)",
          ...
          <Card className="border-dashed">
            <CardContent className="p-4 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <DemoBtn
                  label="Docs Required"
                  active={status === "documents_required"}
          ...
          <p className="text-center text-xs text-muted-foreground">
            ...
            <a href="tel:+919876543210" className="font-medium text-primary hover:underline">
              +91 98765 43210
            </a>
          </p>
        </div>
