          ...
          <div className="h-52 sm:h-64">
            <ResponsiveContainer>
              <PieChart>
                ...
                ]} dataKey="value" innerRadius={50} outerRadius={80} label={({ name }) => name} labelLine={false}>
        ...
        <div className="rounded-xl border bg-card p-4 sm:p-5 lg:col-span-2">
          ...
          <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
            <div className="border-l-2 border-primary pl-3">
              <div className="text-xs uppercase tracking-wide text-muted-foreground">Resolution Rate</div>
              <div className="mt-1 font-display text-2xl font-bold">92.4%</div>
            </div>
            <div className="border-l-2 border-primary/50 pl-3">
              <div className="text-xs uppercase tracking-wide text-muted-foreground">Avg Resolution Time</div>
              <div className="mt-1 font-display text-2xl font-bold">2.4 Days</div>
            </div>
            <div className="border-l-2 border-primary/50 pl-3">
              <div className="text-xs uppercase tracking-wide text-muted-foreground">First-Time Fix Rate</div>
              <div className="mt-1 font-display text-2xl font-bold">85.1%</div>
            </div>
            <div className="border-l-2 border-primary/50 pl-3">
              <div className="text-xs uppercase tracking-wide text-muted-foreground">Provider Growth</div>
